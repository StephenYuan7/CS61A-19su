...
def replace_leaf(t, old, new):
    ...
    branch = []
    for i in branches(t):
        branch.append(replace_leaf(i, old, new))
...
def balanced(m):
    ...
    """
    "*** YOUR CODE HERE ***"
    return (lambda l, r: (lambda le, re: length(l) * total_weight(le) == length(r) * total_weight(re) and (
                is_weight(le) or balanced(le)) and (is_weight(re) or balanced(re)))(end(l), end(r)))(left(m), right(m))
